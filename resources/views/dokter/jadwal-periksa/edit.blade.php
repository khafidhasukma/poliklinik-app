        ...
        <div class="card-body p-8">
            <form action="{{ route('dokter.jadwal-periksa.update', $jadwal->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="hari" class="w-full px-4 py-2 border-2 rounded-lg focus:border-primary focus:outline-none" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="time" name="jam_mulai" value="{{ old('jam_mulai', $jadwal->jam_mulai) }}" class="w-full px-4 py-2 border-2 rounded-lg focus:border-primary focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_selesai" value="{{ old('jam_selesai', $jadwal->jam_selesai) }}" class="w-full px-4 py-2 border-2 rounded-lg focus:border-primary focus:outline-none" required>
